...
const Footer = () => {
  ...
  return (
    <div id='contact' className='footer min-h-footer max-[320px]:h-full max-[375px]:h-full lg:h-1200px xl:h-full 2xl:h-3/4 w-full flex items-center justify-center'>
      <div className='w-4/5 h-full flex flex-col items-center justify-between max-[320px]:pt-10 max-[375px]:pt-20 md:pt-10 lg:pt-96 xl:pt-80 2xl:pt-44 text-slate-300 gap-20'>
