...
const Footer = () => {
  return (
    <div id='contact' className='footer min-h-footer max-[320px]:h-5/6 max-[375px]:h-full lg:h-full xl:h-3/4 w-full flex items-center justify-center'>
      <div className='w-4/5 h-full flex flex-col items-center justify-between max-[320px]:pt-10 max-[375px]:pt-20 md:pt-10 lg:pt-72 xl:pt-44 text-slate-300 gap-20'>
        ...
        <a href="#home"><ArrowCircleUp size={32} color="#A5B4FC" weight="fill" className="lg:hover:fill-contrast-color animate-bounce cursor-pointer"/></a>
