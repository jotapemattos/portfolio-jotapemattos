...
export const CurrentProject = () => {
  return (
    <div id="projects" className="projects-page min-h-full md:h-project md:min-h-project w-full flex justify-center">
      <div className="w-full md:w-4/5 flex flex-col items-center justify-between p-4 gap-10">
        ...
        <div className="w-full md:w-4/5 h-4/5 flex flex-col sm:flex-row items-center justify-between gap-10">
          <div className="flex gap-20 items-start justify-center min-w-full md:min-w-card w-full md:w-card h-full relative">
            <div className='absolute inset-0 bg-slate-300 w-full h-full blur-md opacity-50'></div>
            <div className='bg-gradient-to-tl from-main-color to-second-color relative w-full h-full'></div>
          </div>
          <div className="flex gap-20 items-start justify-center min-w-full md:min-w-card w-full md:w-card h-full relative">
            <div className='absolute inset-0 bg-slate-300 w-full h-full blur-md opacity-50'></div>
            <div className='bg-gradient-to-tl from-second-color to-main-color relative w-full h-full'></div>
          </div>
