...
const portfolioDescription = 'It was built to show people my projects and allow them to get in touch easily! Also, I developed this one to improve my react and tailwind skills, introducing a charming UI.'
...
const comingSoonDescription = 'Come back soon, the next project will be waiting for you!'
    ...
    <div className='projects min-w-full min-h-full overflow-hidden'>
      ...
      <div className="px-6 lg:px-28 pt-6 grid grid-cols-1 2xl:grid-cols-2 items-center justify-between lg:gap-6">
        ...
        <m.div
          ...
          className='flex flex-col lg:flex-row'
        >
          <h1 className='text-3xl font-main text-slate-300 font-bold lg:hidden'>04. Coming Soon</h1>
