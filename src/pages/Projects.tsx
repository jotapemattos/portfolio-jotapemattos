...
export const Projects = () => {
  ...
  return (
    <div className='projects min-w-full min-h-full'>
      <Link to='/' className='flex pt-28 items-center justify-start gap-2 pl-24'>
      ...
      <div className="px-28 pt-6 grid grid-cols-2 items-center justify-between gap-6">
        <div className='flex'>
