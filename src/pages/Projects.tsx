...
const portfolioDescription = 'It was built to show people my projects and allow them get in touch easily! Also, I developed this one to improve my react and tailwind skills, introducing a charming UI.'
